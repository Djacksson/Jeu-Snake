...
# Boucles permettant le déplacement du serpent
    ...
    if coord_tete==coord_pomme:
        ...
        if manger == 200:
            delai1 -= 5
            acceleration1=can.create_text(310,440,font=('Fixedsys',16),text="Bravo, votre adversaire va voir son serpent accélérer !!", fill="WHITE")
...
# Boucles permettant le déplacement du serpent
    ...
    if coord_tete1==coord_pomme1:
        ...
        if manger1 == 200:
            delai -= 5
            acceleration3=can.create_text(930,440,font=('Fixedsys',16),text="Bravo, votre adversaire va voir son serpent accélérer !!", fill="WHITE")
