...
def changecolor_can():
    global color_can
    couleur_can = ['#c0c0c0','#8080ff','#ff925e','#4d4d9b','#0080c0','#00a4a4','#ff71ff','#0062c4','#1a8cff','#77bbff','#ff6a6a']
...
def tp():
    ...
    x_tp1=randrange(30,400,10)
    y_tp1=randrange(30,460,10)
    ...
    x_tp2=randrange(440,680,10)
    y_tp2=randrange(10,460,10)
...
# Boucles permettant le déplacement du serpent
    ...
    if coord_tete==coord_pomme: ## Si les coordonnées de la tête et de la pomme sont les mêmes on fait la boucle
        ...
        #Changement de couleurs "SERPENT" et INTERFACE
        changecolor()
        changecolor_can()
        ...
        manger+=10  #Score ajouté pour chaque pomme
        ...
        if manger==50:      #Apparution des obstacles quand le point atteint 50
            tp()
...
def new_game():
    ...
    can.configure(bg="#a5a5a5")    #couleur de font pour chaque nouvelle partie
...
#######################################################################
def Docs():     #fenetre pour afficher le "Docs"
...
#######################################################################
# Variable de definition du serpent 
#######################################################################
snake=[]
...
#######################################################################
# Première pomme sur l'interface
#######################################################################
pose_pomme()
changecolor()
#######################################################################
